// This file modifies https://github.com/kampersanda/fast_succinct_trie/blob/master/include/fst.hpp to add the method
// getMemoryUsageNoSuffixes().
...
class Trie {
  public:
    ...
    uint64_t getSizeIO() const;
    uint64_t getMemoryUsage() const;
    uint64_t getMemoryUsageNoSuffixes() const;
...
uint64_t Trie::getMemoryUsageNoSuffixes() const {
    return sizeof(Trie) + louds_dense_->getMemoryUsage() + louds_sparse_->getMemoryUsage() +
